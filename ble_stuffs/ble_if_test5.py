...
SCD_STE_SERVICE_UUID = UUID("02a65821-1000-1000-2000-b05cb05cb05c") # ?? purpose was not known
...
"""
target_STE_mode[ 0: 3] = b'\x00\x00\x00\x00'  # [ 0: 3] Unix time
target_STE_mode[ 4: 5] = b'\x0B\x00'          # [    4] sensor En/Disable
                                              # [    5] output data rate
target_STE_mode[ 6: 7] = b'\xE4\x07'          # [ 6: 7] accelerometer threshold
target_STE_mode[12:15] = b'\x00\x00\x00\x00'  # [12:15] light sensor threshold low
target_STE_mode[16:19] = b'\xE8\xE4\xF5\x05'  # [16:19] light sensor threshold high
target_STE_mode[20:21] = b'\x80\x57'          # [20:21] magnetometer threshold
target_STE_mode[26:27] = b'\x80\xF3'          # [26:27] temperature threshold low
target_STE_mode[28:29] = b'\x00\x2D'          # [28:29] temperature threshold high
target_STE_mode[30:31] = b'\xF0\x00'          # [   30] sensor raw value to flash
"""
target_STE_mode[ 0: 4] = b'\x00\x00\x00\x00'  # [ 0: 3] Unix time
target_STE_mode[ 4: 6] = b'\x0B\x00'          # [    4] sensor En/Disable
                                              # [    5] output data rate
