...
###_bits_pattern+= 192                  # [    5] C0 reserved
...
#
target_STE_mode = bytes( STE_mode[0:31] )
...
print ("\tSelf Test Result is [%s]" % (ret_val.hex()))

#############################################
#
# set STE Configuration
#
print("+--- Set STE configuration")
"""
...
print ("\tSTE config. is\n[%s]\n\tsize is [%d]" % (hex_str(target_STE_mode), len(target_STE_mode)))
#
# set STE Mode
#
print("+--- Set STE mode")
...
print ("\tSTE config. is\n[%s]\n\tsize is [%d]" % (hex_str(ret_val), len(ret_val)))
#
