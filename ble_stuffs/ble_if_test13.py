...
STE_RUN_TIME    = 15.   # STE rolling time in secconds
...
STE_bits_pattern+= 2                    # [   30] 02 sensor raw value to flash - magnetometer
STE_bits_pattern+= 4                    # [   30] 04 sensor raw value to flash - light
STE_bits_pattern+= 8                    # [   30] 08 sensor raw value to flash - temperature
...
class NotifyDelegate(DefaultDelegate):
    ...
    def handleNotification(self, cHandle, data):
        global notify_count
        notify_count += 1
        print("**** %2d-#%3d-[%s]" % (cHandle, notify_count, hex_str(data)), end='\n', flush = True)
